...
struct base64sve_bdepx2
{
    std::string encode(const std::string &bytes)
    {
        return BASE64SVE_Adapt::encode(base64sve_encode_bdepx2, bytes);
    }
...
BASE64_REGISTER_ENCODER(base64sve_bdepx2);
BASE64_REGISTER_DECODER(base64sve_bdepx2);