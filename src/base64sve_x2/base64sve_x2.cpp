...
struct base64sve_x2
{
    ...
    {
        return BASE64SVE_X2_Adapt::encode(base64sve_encode_x2, bytes);
    }

    std::string decode(const std::string &base64)
    {
        return BASE64SVE_X2_Adapt::decode(base64sve_decode, base64);
    }
};

BASE64_REGISTER_ENCODER(base64sve_x2);
BASE64_REGISTER_DECODER(base64sve_x2);